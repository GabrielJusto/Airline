...
namespace Airline.Migrations
{
    ...
    [Migration("20260202174456_Add_Timezone_On_Airport")]
    partial class Add_Timezone_On_Airport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airline.Models.Airport", b =>
                {
            ...
            modelBuilder.Entity("Airline.Models.Route", b =>
                {
                    b.HasOne("Airline.Models.Airport", "FromAirport")
                        .WithMany()
                        .HasForeignKey("FromAirportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Airline.Models.Airport", "ToAirport")
                        .WithMany()
